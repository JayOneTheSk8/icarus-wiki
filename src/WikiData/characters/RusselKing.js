...
const appearance = {
    ...
    body: ('<strong>Age 13</strong>\n' +
        'Russel is a skinny dark skinned boy with an unkempt afro. His hair is deceptively long (as seen when Achilles pulls him up by his hair and he is the same height as Reggie off the ground).' +
        '\n\n' +
